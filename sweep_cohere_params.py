"""
Sweep search parameters for Cohere 1M - No Quantization - Recall@100
"""
import numpy as np
import time
import sys
...
NUM_QUERIES = 10000  # All queries
SAMPLE_SIZE = 1000  # Sample for parameter sweep

print("="*80)
print("Cohere 1M - Parameter Sweep - Recall@100")
print("="*80)
...
# Parameter sweep
centroid_counts = [32, 64, 128, 256, 512, 1024]
max_checks = [2048, 4096, 8192, 16384, 32768, 49152]
...
for num_centroids in centroid_counts:
    for max_check in max_checks:
        ...
        with open('sweep_results.log', 'a') as f:
            f.write(result + '\n')
            f.flush()
