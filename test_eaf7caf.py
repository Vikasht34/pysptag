"""
SIFT1M: Test at commit eaf7caf (before metric changes)
"""
import numpy as np
import struct
import time
...
print("="*80)
print("SIFT1M: Test at eaf7caf (L2 only, before metric support)")
print("="*80)
...
print("\n✓ This should show the original working performance")
print("="*80)
