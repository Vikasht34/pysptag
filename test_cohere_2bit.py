"""
Test Cohere 1M with 2-bit quantization
"""
import numpy as np
import h5py
import time
...
INDEX_DIR = '/tmp/cohere_2bit'
NUM_QUERIES = 100

print("="*80)
print("Cohere 1M - 2-bit Quantization Test")
print("="*80)
...
if os.path.exists(os.path.join(INDEX_DIR, 'metadata.pkl')):
    ...
    print("\nBuilding index (2-bit quantization with bit packing)...")
    t0 = time.time()
    index = SPANNDiskOptimized(
        dim=768,
...
print(f"\n{'='*80}")
print("Results (2-bit Quantization):")
